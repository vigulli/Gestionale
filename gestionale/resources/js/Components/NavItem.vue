<template>
  ...
  >
    <span class="w-5 h-5 flex-shrink-0">
      <!-- icon slot or inline SVG by name -->
...
// Minimal inline icon map
const icons = {
  wrench: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l5.653-4.655m5.8-1.938 1.184-1.184a2.25 2.25 0 0 0 0-3.182L13.5 4.82a2.25 2.25 0 0 0-3.182 0l-1.184 1.184" /></svg>`,
...
const iconComponent = computed(() => ({
  render() {
    return h('span', { innerHTML: icons[props.icon] ?? '' })
  }
}))
